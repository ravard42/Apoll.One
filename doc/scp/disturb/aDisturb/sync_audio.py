...
def find_delay(time_pairs):
	...
	plt.scatter([i[0] for i in t_diffs_sorted[10:]], [i[1] for i in t_diffs_sorted[10:]], c='b', edgecolors='black')
	plt.scatter([i[0] for i in t_diffs_sorted[5:10]], [i[1] for i in t_diffs_sorted[5:10]], c='r', edgecolors='black')
	plt.scatter([i[0] for i in t_diffs_sorted[3:5]], [i[1] for i in t_diffs_sorted[3:5]], c='darkgreen', edgecolors='black')
